...
function vah_wp_enqueue_scripts() {
	wp_register_style( 'vah-google-fonts', 'https://fonts.googleapis.com/css?family=Crete+Round:400,400italic|Shrikhand|Open+Sans:300italic,700italic,300,700&display=swap', array(), null, 'all' );
